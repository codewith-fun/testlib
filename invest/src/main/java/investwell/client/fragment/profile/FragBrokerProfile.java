...
public class FragBrokerProfile extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_broker_profile, container, false);
        ...
        if ((mSession.getLoginType().equals("Broker") || mSession.getLoginType().equals("SubBroker") || mSession.getLoginType().equals("RM") || mSession.getLoginType().equalsIgnoreCase("Zone")
            ...
            mTvChangeImage.setVisibility(View.VISIBLE);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.share_layout) {/*  String pckg= "";
        ...
        } else if (id == R.id.help_layout) {//  mActivity.displayViewOther(57, null);
          ...
          /*  case R.id.about_layout:
            ...
            showLogoutDailog(getActivity(), getResources().getString(R.string.account_confirmed_header_txt), getString(R.string.alert_dialog_logout_desc_txt));
        ...
        if ((resultCode == RESULT_OK && requestCode == DEFAULT_LOCK_CODE)) {
            ...
            try {
                ...
                if (selectedImage != null) {
                    Bitmap gallery_bit = MediaStore.Images.Media.getBitmap(Objects.requireNonNull(getActivity()).getContentResolver(), selectedImage);
