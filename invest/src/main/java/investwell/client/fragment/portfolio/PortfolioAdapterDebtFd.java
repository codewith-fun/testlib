...
public class PortfolioAdapterDebtFd extends RecyclerView.Adapter<PortfolioAdapterDebtFd.MyViewHolder> {
    ...
    public PortfolioAdapterDebtFd(Context context, ArrayList<JSONObject> jsonObject1, String CID) {
    ...
    @NonNull
    @Override
    public PortfolioAdapterDebtFd.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        ...
        PortfolioAdapterDebtFd.MyViewHolder vh = new PortfolioAdapterDebtFd.MyViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(PortfolioAdapterDebtFd.MyViewHolder holder, final int position) {
