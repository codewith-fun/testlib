 ...
 * intents.<br>
 * The ic_invest_route_goal of the helper is to simplify the starting and most-common usage of image cropping and
...
public final class CropImage {
  ...
  public static final class ActivityBuilder {
    ...
    public void start(@NonNull Activity activity, int requestCode) {
      mOptions.validate();
      CROP_IMAGE_ACTIVITY_REQUEST_CODE = requestCode;
      activity.startActivityForResult(getIntent(activity), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
