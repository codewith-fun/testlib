...
public class PortFolioEquityMf extends RecyclerView.Adapter<PortFolioEquityMf.MyViewHolder> {
    ...
    public PortFolioEquityMf(Context context, ArrayList<JSONObject> jsonObject1, String CID) {
    ...
    @NonNull
    @Override
    public PortFolioEquityMf.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        ...
        PortFolioEquityMf.MyViewHolder vh = new PortFolioEquityMf.MyViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(PortFolioEquityMf.MyViewHolder holder, final int position) {
