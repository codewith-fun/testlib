...
public class LanguageSupportAdapter extends RecyclerView.Adapter<LanguageSupportAdapter.MyViewHolder> {
    private Context mContext;
    private List<LanguageBean> langList;
    private ArrayList<JSONObject> langJSONList;
    private LanguageClickListener langClickListener;
    private int rowIndex = -1;
    private AppSession appSession;

    public LanguageSupportAdapter(Context context, ArrayList<JSONObject> langLists) {
    ...
    @NonNull
    @Override
    public LanguageSupportAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_row_language_support, parent, false);

        return new LanguageSupportAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(LanguageSupportAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
