...
public class TopHoldingAdapter extends RecyclerView.Adapter<TopHoldingAdapter.MyViewHolder> {

    ArrayList<JSONObject> mDataList;
    Context context;
    private String mDataType = "";
    private AppSession appSession;
    public TopHoldingAdapter(Context context, ArrayList<JSONObject> list) {
    ...
    @NonNull
    @Override
    public TopHoldingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {


        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_factsheet_holding, parent, false);
        TopHoldingAdapter.MyViewHolder vh = new TopHoldingAdapter.MyViewHolder(v);

        return vh;
    }

    @Override
    public void onBindViewHolder(final TopHoldingAdapter.MyViewHolder holder, final int position) {
