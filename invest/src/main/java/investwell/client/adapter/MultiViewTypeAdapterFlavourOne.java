...
private int mScreenWidth=0;
    public MultiViewTypeAdapterFlavourOne(Context context, ArrayList<JSONObject> sectionArrayList) {
...
mScreenWidth=getDisplayWidth();
        if (viewType == TYPE_CARD) { // for call layout_gridview_type_two_a
            if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
                ...
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_cardview_flavour_one_c, viewGroup, false);
            } else if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
                    (Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1D") || Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1B"))) {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_cardview_flavour_one_d, viewGroup, false);
            } else {
                if (imgType.equalsIgnoreCase("Background"))
                    view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_cardview_flavour_one_d, viewGroup, false);
                else
                    view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_cardview_flavour_one, viewGroup, false);
            }
            return new MultiViewTypeAdapterFlavourOne.CardViewHolder(view);
        } else if (viewType == TYPE_SLIDER) { // for email layout_gridview_type_two_a
            if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
                    Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1C")) {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_sliderview_flavour_one_c, viewGroup, false);
            } else if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
                    (Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1D") || Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1B"))) {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_sliderview_flavour_one_d, viewGroup, false);
            } else {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_sliderview_flavour_one, viewGroup, false);
            }
            return new MultiViewTypeAdapterFlavourOne.SliderViewHolder(view);
        } else if (viewType == TYPE_GRID) {
            if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
                    (Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1D") || Utils.getConfigData(mSession).optString("APPType").equalsIgnoreCase("Type 1B"))) {
                if (imgType.equalsIgnoreCase("Background"))
                    view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_dashboard_gridview_flavour_one_d, viewGroup, false);
                else
            ...
            return new MultiViewTypeAdapterFlavourOne.GridViewHolder(view);
        }
        return null;
    }
                ...
                public void onClick(View view) {
                    ...
                    if (childType.equalsIgnoreCase("Module")) {
                        if (!TextUtils.isEmpty(cardViews.optString("ChildCode"))) {
                            ...
                            /*if ((childCode.equalsIgnoreCase("TopSIPSchemes") || childCode.equalsIgnoreCase("TopELSSSchemes") || childCode.equalsIgnoreCase("TopLiquidSchemes"))) {
                                Bundle bundle = new Bundle();
                                ...
                                mSession.setTopPerformerDesc(description);
                                bundle.putString("type", topSchemeType);
                                mActivity.displayViewOther(111, bundle);
                            }*/
                            if (childCode.equalsIgnoreCase("SearchAMC")) {
    ...
    class GridViewHolder extends RecyclerView.ViewHolder {
        ...
        void setGridViews(final JSONObject gridViews) {
            tvHeader.setText(!TextUtils.isEmpty(gridViews.optString("ChildTitle")) ? gridViews.optString("ChildTitle") : "Header");
