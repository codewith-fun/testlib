...
public class IndicatorAdapter extends RecyclerView.Adapter<IndicatorAdapter.MyViewHolder> {
    ...
    public IndicatorAdapter(Context context, ArrayList<JSONObject> jsonObject1, String CID) {
    ...
    @NonNull
    @Override
    public IndicatorAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_port_tab_based, parent, false);
        }
        IndicatorAdapter.MyViewHolder vh = new IndicatorAdapter.MyViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull IndicatorAdapter.MyViewHolder holder, final int position) {
        ...
        holder.tv_objective.setText(!TextUtils.isEmpty(jsonObject.optString("Objective"))?jsonObject.optString("Objective"):"");
        holder.tv_objective.setVisibility(View.GONE);
       ...
       /* Picasso.with(context).load(jsonObject.optString("AMCLogo")).into(holder.mLogo);*/
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView applicant_name, purchase_cost, market_value, gain, cagr, folio, tv_objective;
        ImageView next_arrow, gain_arrow, cagr_arrow,mIvInfo, mLogo;
        ...
        public MyViewHolder(View view) {
            ...
            tv_objective = view.findViewById(R.id.tv_objective);
