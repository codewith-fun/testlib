...
public class FragGoalSummaryAdapter extends RecyclerView.Adapter<FragGoalSummaryAdapter.ViewHolder> {
    public ArrayList<JSONObject> mDataList;

    private Context mContext;
    private FragGoalSummaryAdapter.OnItemClickListener listener;
    private AppSession mSession;

    public FragGoalSummaryAdapter(Context context, ArrayList<JSONObject> list, FragGoalSummaryAdapter.OnItemClickListener listener) {
        mContext = context;
        mDataList = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.frag_goal_summary_adapter, viewGroup, false);
