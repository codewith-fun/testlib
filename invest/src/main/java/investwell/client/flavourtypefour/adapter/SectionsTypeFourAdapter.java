...
public class SectionsTypeFourAdapter extends RecyclerView.Adapter<SectionsTypeFourAdapter.MyViewHolder> {
    ...
    public SectionsTypeFourAdapter(Context context, ArrayList<JSONObject> sectionArrayList) {
    ...
    @NonNull
    @Override
    public SectionsTypeFourAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_dashboard_flavour_four, parent, false);


        initializer();
        return new SectionsTypeFourAdapter.MyViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(SectionsTypeFourAdapter.MyViewHolder holder, final int position) {
