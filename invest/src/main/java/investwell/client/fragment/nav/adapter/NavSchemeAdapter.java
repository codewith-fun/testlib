...
import investwell.client.fragment.nav.fragment.FragNavItemSchemes;
...
public class NavSchemeAdapter extends RecyclerView.Adapter<NavSchemeAdapter.ViewHolder> {
    ...
    public NavSchemeAdapter(Context context, ArrayList<JSONObject> mDataList, FragNavItemSchemes frag) {
        this.mDataList = mDataList;
        this.mContext = context;
        this.mFrag = (FragNavScheme) frag.getParentFragment();
...
//        if (position % 2 == 0) {
//            viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(mContext, R.color.colorGrey_100));
//        } else {
        ...
        viewHolder.mCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mFrag.toolbarFragment.updateCart(true);
                    if (mFrag.mSelectedCartsList.size() == 0) {
