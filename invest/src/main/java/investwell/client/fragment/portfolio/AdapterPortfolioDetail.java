...
public class AdapterPortfolioDetail extends RecyclerView.Adapter<AdapterPortfolioDetail.MyViewHolder> {
    ...
    public AdapterPortfolioDetail(Context context, ArrayList<JSONObject> jsonObject1, String CID) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (!TextUtils.isEmpty(Utils.getConfigData(mSession).optString("APPType")) &&
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_portfolio_detail, parent, false);
        }
