...
public class DashboardTypeOneGridAdapter extends RecyclerView.Adapter<DashboardTypeOneGridAdapter.MyViewHolder> {
    private Context mContext;
    public ArrayList<JSONObject> sectionArrayList;
    private GridItemClickListener otherServicesListener;
    private AppSession mSession;
    private View itemView;

    public DashboardTypeOneGridAdapter(Context context, ArrayList<JSONObject> list, GridItemClickListener otherServicesListeners) {
    ...
    @NonNull
    @Override
    public DashboardTypeOneGridAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_row_grid_section, parent, false);

        return new DashboardTypeOneGridAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(DashboardTypeOneGridAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
