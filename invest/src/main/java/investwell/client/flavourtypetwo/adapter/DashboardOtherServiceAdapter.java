...
public class DashboardOtherServiceAdapter extends RecyclerView.Adapter<DashboardOtherServiceAdapter.MyViewHolder> {
    private Context mContext;
    public ArrayList<JSONObject> sectionArrayList;
    private OtherServicesClickListener otherServicesListener;
    private AppSession mSession;
    private View itemView;

    public DashboardOtherServiceAdapter(Context context, ArrayList<JSONObject> list, OtherServicesClickListener otherServicesListeners) {
    ...
    @NonNull
    @Override
    public DashboardOtherServiceAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_row_other_services_type_2b, parent, false);

        return new DashboardOtherServiceAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(DashboardOtherServiceAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
